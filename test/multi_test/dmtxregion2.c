 ...
 *
 */
double UncompactOffset(double compactedOffset, int phiIdx, int extent)
{
    double phiRad;
    double scale;
 ...
 */
DmtxHoughBucket GetAngleSumAtPhi(DmtxHoughLocal *line, int phi)
{
    int i, d;
    int prev, here, next;
    DmtxHoughBucket bucket;
 ...
 *
 */
DmtxTimingSort dmtxFindGridTiming(DmtxHoughLocal *line, VanishPointSort *vPoints)
{
 ...
 *
 */
DmtxPassFail dmtxFindRegionWithinGrid(GridRegion *region, AlignmentGrid *grid, DmtxHoughLocal *line, DmtxDecode *dec,
                                      DmtxCallbacks *fn)
{
    int goodCount;
    int finderSides;
 ...
 *
 */
DmtxPassFail Vector2Norm(DmtxVector2 *v)
{
    double mag;
 ...
 *
 */
DmtxPassFail RayFromPoints(DmtxRay2 *ray, DmtxVector2 p0, DmtxVector2 p1)
{
    DmtxRay2 r;
 ...
 *
 */
DmtxPassFail dmtxRegionToSides(GridRegion *region, DmtxRegionSides *regionSides)
{
    DmtxVector2 p00, p10, p11, p01;
    DmtxRegionSides rs;
 ...
 *
 */
DmtxPassFail dmtxRegionUpdateFromSides(GridRegion *region, DmtxRegionSides regionSides)
{
    DmtxVector2 p00, p10, p11, p01;
    ...
    RETURN_FAIL_IF(RegionUpdateCorners(region->grid.fit2rawActive, region->grid.raw2fitActive, p00, p10, p11, p01) ==
                   DmtxFail);
 ...
 *
 */
DmtxPassFail RegionExpand(GridRegion *region, DmtxDirection sideDir, DmtxHoughLocal *line, DmtxCallbacks *fn)
{
 ...
 *
 */
DmtxPassFail RegionUpdateCorners(DmtxMatrix3 fit2raw, DmtxMatrix3 raw2fit, DmtxVector2 p00, DmtxVector2 p10,
